...
function Filter(props){
    ...
    return(
        <div className='flex justify-center '>
            <div className="nav-elements m-4 flex flex-wrap">
                {
                    props.courseName.map((course) =>{
                        return <button onClick={myCourseHandler} className={`filter-btn font-semibold ml-4 bg-[#2d2d35] text-white p-2 text-[18px] rounded-lg ${
